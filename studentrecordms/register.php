...
<option VALUE="">Select Country</option>
 ...
 <select name="state" id="state"  class="form-control" onchange="showDist(this.value)" required="required">
	...
	<!-- jQuery -->
	<script src="browser_components/jquery/dist/jquery.min.js" type="text/javascript"></script>
	<!-- Bootstrap Core JavaScript -->
	<script src="browser_components/bootstrap/dist/js/bootstrap.min.js" type="text/javascript"></script>
	<!-- Metis Menu Plugin JavaScript -->
	<script src="browser_components/metisMenu/dist/metisMenu.min.js" type="text/javascript"></script>
